...
extern "C" {
  ...
  SEXP rNNGPgeo(SEXP y_r, SEXP X_r, SEXP p_r, SEXP n_r, SEXP m_r, SEXP coords_r, SEXP covModel_r, SEXP nnIndx_r, SEXP nnIndxLU_r,
    ...
    //update B and F
    // BJ: changed //
    logDetCurrent = updateBFgeo(B, F, c, C, coords, nnIndx, nnIndxLU, n, m, theta, tauSqIndx, sigmaSqIndx, phiIndx, nuIndx, covModel, bk, nuUnifb, distvec);
    ...
    for(s = 0; s < nSamples; s++){
      ...
      //update B and F
      // BJ: changed //
      logDetCand = updateBFgeo(B, F, c, C, coords, nnIndx, nnIndxLU, n, m, thetaCand, tauSqIndx, sigmaSqIndx, phiIndx, nuIndx, covModel, bk, nuUnifb, distvec);
