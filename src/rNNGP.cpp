...
double updateBF(double *B, double *F, double *c, double *C, double *coords, int *nnIndx, int *nnIndxLU, 
                int n, int m, double *theta, int tauSqIndx, int sigmaSqIndx, int phiIndx, int nuIndx, 
...
double updateBF_geo(double *B, double *F, double *c, double *C, double *coords, int *nnIndx, int *nnIndxLU, 
                    int n, int m, double *theta, int tauSqIndx, int sigmaSqIndx, int phiIndx, int nuIndx, 
                    int covModel, double *bk, double nuUnifb, 
...
extern "C" {
  ...
  SEXP rNNGP_geo(SEXP y_r, SEXP X_r, SEXP p_r, SEXP n_r, SEXP m_r, SEXP coords_r, SEXP covModel_r, SEXP nnIndx_r, SEXP nnIndxLU_r,
    ...
    //update B and F
    // BJ: changed //
    logDetCurrent = updateBF_geo(B, F, c, C, coords, nnIndx, nnIndxLU, n, m, theta, tauSqIndx, sigmaSqIndx, phiIndx, nuIndx, covModel, bk, nuUnifb, distvec);
    ...
    for(s = 0; s < nSamples; s++){
      ...
      //update B and F
      // BJ: changed //
      logDetCand = updateBF_geo(B, F, c, C, coords, nnIndx, nnIndxLU, n, m, thetaCand, tauSqIndx, sigmaSqIndx, phiIndx, nuIndx, covModel, bk, nuUnifb, distvec);
